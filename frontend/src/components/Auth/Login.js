...
const Login = () => {
  ...
  return (
    <>
    <Helmet>
      <title>Login - LabX Virtual Laboratory Platform</title>
      <meta name="description" content="Sign in to your LabX account to access virtual laboratories, courses, and interactive learning experiences." />
    </Helmet>
