                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd className="text-lg font-medium text-gray-900">{systemStats.totalProfessors}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        {pendingApprovals.map((approval) => (
                            <li key={approval.id} className="px-4 py-4 sm:px-6">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <div className="flex-shrink-0">
                                            {approval.type === 'course' && <BookOpen className="h-5 w-5 text-gray-400" />}
                                            {approval.type === 'user' && <UserPlus className="h-5 w-5 text-gray-400" />}
                                            {approval.type === 'content' && <FileText className="h-5 w-5 text-gray-400" />}
                                        </div>
                                        <div className="ml-4">
                                            <div className="text-sm font-medium text-gray-900">{approval.title}</div>
                                            <div className="text-sm text-gray-500">Submitted by: {approval.submittedBy}</div>
                                        </div>
                                    </div>
                        ...
                        {systemAlerts.map((alert) => (
                            <li key={alert.id} className="px-4 py-4 sm:px-6">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <div className="flex-shrink-0">
                                            <div className={`h-5 w-5 rounded-full ${alert.type === 'warning' ? 'bg-yellow-400' :
